    ...
    b.count = 0, b.VALID_NODES = ["P", "PRE", "BLOCKQUOTE", "H1", "H2", "H3", "H4", "H5", "H6", "DIV"], b.COLORS = ["#000000", "#444444", "#666666", "#999999", "#CCCCCC", "#EEEEEE", "#F3F3F3", "#FFFFFF", "#FF0000", "#FF9900", "#FFFF00", "#00FF00", "#00FFFF", "#0000FF", "#9900FF", "#FF00FF", "#F4CCCC", "#FCE5CD", "#FFF2CC", "#D9EAD3", "#D0E0E3", "#CFE2F3", "#D9D2E9", "#EAD1DC", "#EA9999", "#F9CB9C", "#FFE599", "#B6D7A8", "#A2C4C9", "#9FC5E8", "#B4A7D6", "#D5A6BD", "#E06666", "#F6B26B", "#FFD966", "#93C47D", "#76A5AF", "#6FA8DC", "#8E7CC3", "#C27BA0", "#CC0000", "#E69138", "#F1C232", "#6AA84F", "#45818E", "#3D85C6", "#674EA7", "#A64D79", "#990000", "#B45F06", "#BF9000", "#38771D", "#134F5C", "#0B5394", "#351C75", "#741B47", "#660000", "#783F04", "#7F6000", "#274E13", "#0C343D", "#073763", "#201211", "#4C1130"], b.image_commands = {
        ...
        this.$element.on("keyup keydown focus placeholderCheck", a.proxy(function (b) {
            ...
            if (this.isEmpty() && !this.isHTML && "keydown" !== b.type) {
                if (this.options.paragraphy) var c = a("<p>&#8203;</p>");
                else var c = a("<div>&#8203;</div>");
                this.$element.html(c), this.setSelection(c.get(0), 1, null, 1), this.$element.addClass("f-placeholder")
            } else this.$element.find("p, div").length ? this.isEmpty() === !1 && this.$element.removeClass("f-placeholder") : (this.wrapText(), this.$element.find("p, div").length ? this.setSelection(this.$element.find("p, div")[0], this.$element.find("p, div").text().length, null, this.$element.find("p, div").text().length) : this.$element.removeClass("f-placeholder"))
        ...
        if (this.selectionInEditor()) {
            if ("" === this.text() && ("bold" === a || "italic" === a || "underline" === a || "strikeThrough" == a)) return this.$element.focus(), this.$bttn_wrapper.find('[data-cmd="' + a + '"]').toggleClass("active"), document.execCommand(a), !1;
            if ("" === this.text() && "fontSize" !== a && "formatBlock" !== a && "indent" !== a && "outdent" !== a && "justifyLeft" !== a && "justifyRight" !== a && "justifyFull" !== a && "justifyCenter" !== a && "html" !== a && "undo" !== a && "redo" !== a && "selectAll" !== a && "save" !== a && "insertImage" !== a && "insertVideo" !== a && "insertOrderedList" !== a && "insertUnorderedList" !== a) return !1
        }
        switch (a) {
        case "fontSize":
            this.fontSize(b);
        ...
        for (var e in c) {
            ...
            if (d = "n" == b ? a("<div>").html(f.html()) : a("<" + b + ">").html(f.html()), f.get(0) != this.$element.get(0) && "LI" != f.get(0).tagName) {
                ...
                if (d.attr)
                    for (var h in g) d.attr(g[h].name, g[h].value);
                f.replaceWith(d)
            } else f.html(d)
        }
        ...
        if (this.clearSelection(), this.wrapText(), this.restoreSelectionByMarkers(), e === !1) {
            ...
            for (var j in d) c = a(d[j]), c.get(0) != this.$element.get(0) && (i.append(a("<li>").append(c.clone())), j != d.length - 1 ? c.remove() : (c.replaceWith(i), i.find("li")));
            this.restoreSelectionByMarkers()
        }
